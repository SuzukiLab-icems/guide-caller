...
function exec_CRISPRko {
	sh ${FILE_PATH}/src/trimCRISPRko.sh ${fastq_directory} ${sample} ${barcode_length} ${cpu_core}
	sh ${FILE_PATH}/src/countGuide.sh ${fastq_directory} ${sample} ${alignment} ${FILE_PATH}
}

function exec_CRISPRia {
	echo 'Now setting..'
	#sh ${FILE_PATH}/src/trimCRISPRia.sh ${fastq_directory} ${sample} ${barcode_length} ${cpu_core}
	#sh ${FILE_PATH}/src/countGuide.sh ${fastq_directory} ${sample} ${alignment} ${FILE_PATH}
}
