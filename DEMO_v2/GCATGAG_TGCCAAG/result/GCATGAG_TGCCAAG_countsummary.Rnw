...
library(xtable)
filelist=c("./DEMO_v2/GCATGAG_TGCCAAG/GCATGAG_TGCCAAG_trimmed_ 1.fastq.gz");
labellist=c("sample1");
reads=c(10000);
mappedreads=c(5378);
totalsgrnas=c(119461);
zerocounts=c(115321);
giniindex=c(0.9692156694531981);
...
genboxplot("GCATGAG_TGCCAAG.count_normalized.txt");
@
...
genhistplot("GCATGAG_TGCCAAG.count_normalized.txt");
@
