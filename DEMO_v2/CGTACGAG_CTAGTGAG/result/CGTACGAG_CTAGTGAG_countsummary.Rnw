...
library(xtable)
filelist=c("./DEMO_v2/CGTACGAG_CTAGTGAG/CGTACGAG_CTAGTGAG_trim med_1.fastq.gz");
labellist=c("sample1");
reads=c(10000);
mappedreads=c(6154);
totalsgrnas=c(119461);
zerocounts=c(115102);
giniindex=c(0.9683895105792223);
...
genboxplot("CGTACGAG_CTAGTGAG.count_normalized.txt");
@
...
genhistplot("CGTACGAG_CTAGTGAG.count_normalized.txt");
@
